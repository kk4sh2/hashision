...
Try:
  ...
  python3 collision_analyzer.py compare-files samples/sample1.txt samples/sample2.txt
...
two "shattered" SHA-1 PDFs published in 2017), drop them in this folder and run:
  ...
  python3 collision_analyzer.py compare-files samples/shattered-1.pdf samples/shattered-2.pdf --algorithm sha1
  python3 collision_analyzer.py compare-files samples/shattered-1.pdf samples/shattered-2.pdf --algorithm sha256
